            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                <input
                  ...
                  className="w-full px-4 py-3 md:py-4 border border-gray-300 rounded-lg text-right text-sm md:text-base focus:outline-none focus:border-[#04ccf0] focus:ring-1 focus:ring-[#04ccf0]"
                />
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-end gap-4 md:gap-8 mt-6">
                <a href="#" className="flex items-center gap-2 text-gray-800 hover:text-gray-600 text-sm md:text-base">
                  نسيت كلمة المرور
