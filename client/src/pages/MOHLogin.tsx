          ...
          <div style={{ maxWidth: 500, margin: '40px auto', padding: '0 20px' }}>
            ...
            <div style={{ textAlign: 'center', marginTop: 25 }}>
              <p style={{ fontSize: 14, color: '#555', marginBottom: 8 }}>
                {tx.noAccount} <a href="#" onClick={(e) => e.preventDefault()} style={{ color: '#1076BB', textDecoration: 'none', fontWeight: 'bold' }}>{tx.createAccount}</a>
              </p>
              <p>
                <a href="#" onClick={(e) => e.preventDefault()} style={{ color: '#1076BB', textDecoration: 'underline', fontSize: 14 }}>{tx.userGuide}</a>
              </p>
            </div>
          </div>
        )}
