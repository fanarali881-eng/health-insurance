          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl p-6 text-right flex flex-col">
              <div className="flex justify-end mb-4">
                <img src="/images/warning-icon.png" alt="تحذير" className="w-12 h-12 object-contain" />
              </div>
            ...
            <div className="bg-white rounded-xl p-6 text-right flex flex-col">
              <div className="flex justify-end mb-4">
                <img src="/images/phone-icon.png" alt="اتصل بنا" className="w-12 h-12 object-contain" />
              </div>
