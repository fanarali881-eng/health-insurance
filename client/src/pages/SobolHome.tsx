          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 text-right">
              <div className="flex items-start gap-4 flex-row-reverse">
                <img src="/images/warning-icon.png" alt="تحذير" className="w-14 h-14 object-contain" />
            ...
            <div className="bg-white rounded-xl p-6 text-right">
              <div className="flex items-start gap-4 flex-row-reverse">
                <img src="/images/phone-icon.png" alt="اتصل بنا" className="w-14 h-14 object-contain" />
                <div className="flex-1">
